...
#define SPROUT_PP_UNIQUE_WSTRING \
	...
	SPROUT_PP_WSTR(" ") SPROUT_PP_WSTRINGIZE(SPROUT_PP_SOME_NUMBER_OR_EMPTY())
#define SPROUT_PP_UNIQUE_U16STRING \
	...
	SPROUT_PP_U16STR(" ") SPROUT_PP_U16STRINGIZE(SPROUT_PP_SOME_NUMBER_OR_EMPTY())
#define SPROUT_PP_UNIQUE_U32STRING \
	...
	SPROUT_PP_U32STR(" ")  SPROUT_PP_U32STRINGIZE(SPROUT_PP_SOME_NUMBER_OR_EMPTY())
